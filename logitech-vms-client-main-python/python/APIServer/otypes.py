...
from .models import PyObjectId, Links, Package
...
@strawberry.experimental.pydantic.type(model=Package, all_fields=True)
class FullPackageType:
    pass
...
@strawberry.experimental.pydantic.input(model=Package, all_fields=True)
class PackageMutationInput:
    pass